...
description: |
  十八步财务分析法 v3.1 - 专业企业财务诊断系统（详细完整版）
  ...
  报告输出结构：
  1. 十八步详细分析（每步包含：检查目的/计算公式/判断标准/数据表格/详细分析结论）
  2. 十八步达标测评汇总表
  3. 百分制打分
  4. 结论与建议
  ...
  触发条件：用户要求十八步分析、财务诊断、企业财务评估、财务健康检查等。
---

# 十八步财务分析法 Skill v3.1（详细完整版）
...
### 报告头部
```markdown
# [公司名称](股票代码) 十八步财务分析报告（详细版）

**分析期间**：XXXX-XXXX年  
**数据来源**：用户提供CSV财务数据  
**分析日期**：XXXX年XX月XX日  
**分析框架**：十八步财务分析法 v3.1（详细版）
```
...
**评分规则**: 十八步核心维度每项基础分5.56分（100÷18），未达标根据偏离程度扣1-3分
...
- 详细分析模板: `report/迈瑞医疗_300760_十八步财务分析报告_详细版_20260401.md`
